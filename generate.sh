...
input_flag=false                           # flag to check if custom input directory is provided
out_flag=false                             # flag to check if custom output directory is provided
colors_flag=false                          # flag to check if custom colors are provided
help_flag=false                            # flag to check if help is called
...
input_dir="./src"
output_dir="./dynamic-color-gtk-theme"
test_yml="./test.yml"
#----------------------------------------#
