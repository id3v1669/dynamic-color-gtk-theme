...
for theme in '' '-Purple' '-Pink' '-Red' '-Orange' '-Yellow' '-Green' '-Blue' '-Grey'; do
    for type in '' '-Storm' '-Moon'; do
        ...
        if [[ "$type" != '' ]]; then
            ...
            sed -i "s/#fe8019/${theme_color_dark}/g" "thumbnail${theme}${type}.svg"
            sed -i "s/#af3a03/${theme_color_light}/g" "thumbnail${theme}${type}.svg"
            sed -i "s/#fbf1c7/${panel_light}/g" "thumbnail${theme}${type}.svg"
            sed -i "s/#282828/${panel_dark}/g" "thumbnail${theme}${type}.svg"
            ...
            sed -i "s/#fe8019/${theme_color_dark}/g" "thumbnail${theme}.svg"
            sed -i "s/#af3a03/${theme_color_light}/g" "thumbnail${theme}.svg"
